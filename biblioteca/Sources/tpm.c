...
void initTPM(uint8_t modulo, uint8_t pre, uint16_t counter, uint8_t cpwms) {
	...
	switch(modulo) {
	case 0:
		SIM_SCGC6 |= SIM_SCGC6_TPM0_MASK;/*TPM0*/        ///< TPM0=SIM_SCGC6[24]=1 (Clock gate de TPM0 habilitado)
		...
		break;
	case 1:
		SIM_SCGC6 |= SIM_SCGC6_TPM1_MASK;/*TMP1*/        ///< TPM0=SIM_SCGC6[25]=1 (Clock gate de TPM1 habilitado)
		...
		break;
	case 2:
		SIM_SCGC6 |= SIM_SCGC6_TPM2_MASK;/*TMP2*/        ///< TPM0=SIM_SCGC6[26]=1 (Clock gate de TPM2 habilitado)
	...
	*tpm_sc &= ~(TPM_SC_DMA_MASK |               ///< DMA=TPMx_SC[8]=0 (desabilita DMA)
				TPM_SC_TOIE_MASK);/*ftp://ftp.dca.fee.unicamp.br/pub/docs/ea871/ARM/KL25P80M48SF0RM.pdf#page=547 NA PAGINA 553 */     ///< TOIE=TPMx_SC[6]=0 (desabilita interrup&ccedil;&atilde;o "overflow")
...
uint8_t enableTPMInterrup(uint8_t modulo) {
	...
	*tpm_sc |= TPM_SC_TOIE_MASK;         /*ftp://ftp.dca.fee.unicamp.br/pub/docs/ea871/ARM/KL25P80M48SF0RM.pdf#page=547 NA PAGINA 553*/
...
uint8_t enableTPM0CnInterrup(uint8_t canal) {
	...
	*tpm_cnsc |= TPM_CnSC_CHIE_MASK;       /*ftp://ftp.dca.fee.unicamp.br/pub/docs/ea871/ARM/KL25P80M48SF0RM.pdf#page=547 PAGINA 556*/
...
uint8_t disableTPM0CnInterrup(uint8_t canal) {
	...
	*tpm_cnsc &= ~TPM_CnSC_CHIE_MASK;         /*ftp://ftp.dca.fee.unicamp.br/pub/docs/ea871/ARM/KL25P80M48SF0RM.pdf#page=547 NA PAGINA 556*/
