...
void enableNVICUART(uint8_t priority) {
	 ...
	 */
    NVIC_ISER |= 1 << (28-16);//12 ftp://ftp.dca.fee.unicamp.br/pub/docs/ea871/ARM/KL25P80M48SF0RM.pdf  seccao 3.3.2.3            // i) Habilite interrup&ccedil;&atilde;o UART0
    NVIC_ICPR |= 1 << (28-16);//12 ftp://ftp.dca.fee.unicamp.br/pub/docs/ea871/ARM/KL25P80M48SF0RM.pdf  seccao 3.3.2.3            // e limpe as pendencias
